...
public class MyStackTest {
	...
	public void testPopStudent() throws StackUnderflowException{
		...
		stringS.pop();
		assertEquals("ab", stringS.toString());
	}
	...
	@Test
	public void testSize() throws StackUnderflowException {
	...
	public void testToStringStudent() {
		...
		assertEquals("abc", stringS.toString());
		stringS.push("push");
		assertEquals("abcpush", stringS.toString());
		stringS.push(e);
		assertEquals("abcpushe", stringS.toString());
	}
