...
public class MyQueueTest {
	...
	public void testDequeueStudent() throws QueueUnderflowException{
		...
		stringQ.dequeue();
		assertEquals("bc",stringQ.toString());
		stringQ.dequeue();
		assertEquals("c",stringQ.toString());
	}
	...
	public void testEnqueueStudent() {
		assertEquals("abc",stringQ.toString());
		stringQ.enqueue("Push");
		assertEquals("abcPush",stringQ.toString());
		stringQ.enqueue(e);
		assertEquals("abcPushe",stringQ.toString());
	}
	...
	public void testToStringStudent() throws QueueUnderflowException{
		assertEquals("abc", stringQ.toString());
		stringQ.enqueue(e);
		assertEquals("abce", stringQ.toString());
		stringQ.dequeue();
		assertEquals("bce", stringQ.toString());
	}
